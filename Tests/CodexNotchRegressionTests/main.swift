...
runner.check(AppInfo.version == "0.4.2", "app info should expose version 0.4.2")
runner.check(AppInfo.displayVersion == "0.4.2", "app info should fall back to source version when bundle version is unavailable")
