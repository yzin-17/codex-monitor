...
runner.check(AppInfo.version == "0.1.17", "app info should expose version 0.1.17")
runner.check(AppInfo.displayVersion == "0.1.17", "app info should fall back to source version when bundle version is unavailable")
