...
runner.check(AppInfo.version == "0.3.0", "app info should expose version 0.3.0")
runner.check(AppInfo.displayVersion == "0.3.0", "app info should fall back to source version when bundle version is unavailable")
